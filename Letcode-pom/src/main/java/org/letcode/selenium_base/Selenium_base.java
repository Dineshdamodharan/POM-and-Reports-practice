...
public class Selenium_base implements InterfaceBase{
 long timeOuts = 10; //30
 long maxWaitTime =10;
 ...
 public void setUp(Browser browserName, String url) {
  ...
  case EDGE:
   ...
   break;
  default:
   System.err.println("Driver i not defined");
   break;
  }
  driver.manage().window().maximize();
  driver.manage().timeouts().
 ...
 // TODO: function to check if the dropdown i selected ?

 public void selectValue(WebElement ele, String value) {
  WebElement element = iElementViible(ele);
 ...
 public void click(WebElement ele) {
  WebElement element = wait
    .withMessage("Element i not clickable")
 ...
 private WebElement iElementViible(WebElement ele) {
  WebElement element = wait.
    withMessage("Element i not viible")
    .until(
      ExpectedConditions
      .visibilityOf(ele));
  return element;
 ...
 public boolean iDiplayed(WebElement ele) {
